...
to complete. Your PC or VM must have at least 1.5 GB of RAM or Rubies will 
...
Install dependencies needed to compile Rubies: 
--------------------- 
...
mkdir $HOME/rubies
cd $HOME/rubies
git clone https://github.com/BetterBetsLobos/rubies-core.git
cd rubies-core/src/leveldb
...
Qt GUI wallet build + extra dependencies: (if you have already built the daemon you wont need to clone the Rubies repository)
--------------------
cd $HOME
mkdir $HOME/deps
cd $HOME/deps
