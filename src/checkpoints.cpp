...
namespace Checkpoints
{
    ...
    static MapCheckpoints mapCheckpoints =
        boost::assign::map_list_of
            ...
            (43245, CheckpointBlock4)
            (56700, CheckPointBlock5)
            (84500, CheckPointBlock6)
            (108000, ChechPointBlock7)
    ...
    // rubies: synchronized checkpoint (centrally broadcasted)
    ...
    // rubies: get last synchronized checkpoint
    ...
    // rubies: only descendant of current sync-checkpoint is allowed
    ...
    // rubies: reset synchronized checkpoint to last hardened checkpoint
...
// rubies: verify signature of sync-checkpoint message
...
// rubies: process synchronized checkpoint
